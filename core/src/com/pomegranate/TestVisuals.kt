...
class TestVisuals() {
    ...
    val ta2 = TimedAtlasAnimation(Gdx.files.internal("placeholderAtlas/cats.atlas"), "still", fps = 2f, visualSize = VisualSize.FIT_ELEMENT, scaleRatio = 0.5f, fitAll = true).also{
        it.recolour(Color.CYAN)
    }
    val ta3 = TimedAtlasAnimation(Gdx.files.internal("placeholderAtlas/cats.atlas"), "move", fps = 2f, visualSize = VisualSize.FIT_ELEMENT, scaleRatio = 0.5f, fitAll = true).also{
