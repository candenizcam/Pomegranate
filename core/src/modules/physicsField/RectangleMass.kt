...
open class RectangleMass(id: String, w: Float, h: Float, override var mass: Float, cX: Float = 0f, cY: Float = 0f, vX: Float = 0f, vY: Float = 0f, override var mobility: Boolean) : PhysicsItem(id) {
